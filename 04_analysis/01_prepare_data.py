...
def preprocessQuestionnaireData():
    fileLocation = '../03_data/questionnaire'
    ...
    analysisData.to_csv('{}/demographics_data.csv'.format(outLocation), sep=';', encoding='utf-8', index=False)
    
    #Save full data file as CSV for the R analysis
    data.to_csv('{}/questionnaire_data.csv'.format(outLocation), sep=';', encoding='utf-8', index=False)


def prepareStudiesData():
    fileLocation = '../03_data/studies'
